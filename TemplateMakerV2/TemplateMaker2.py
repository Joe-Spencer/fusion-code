...
def run(context):
    ...
    try:
        ...
        # set setup origin
        setup.parameters.itemByName('wcs_origin_boxPoint').value.value = SetupWCSPoint.BOTTOM_XMAX_YMIN.value
        ...
        ui.messageBox(str(setup.operations.compatibleStrategies))
